...
class BookRepository {
  ...
  static Future<BookInfo> fetchBookInfo(Uri url) => _findAdapter(url).fetchBookInfo(url);

  static Future<ChapterList> fetchChapterList(Uri url) => _findAdapter(url).fetchChapterList(url);

  static Future<Object> fetchFromUrl(Uri url) => _findAdapter(url).fetchFromUrl(url);

  static Future<Type> fetchResourceType(Uri url) => _findAdapter(url).fetchResourceType(url);
